...
namespace HueFestivalAPI.Migrations
{
    ...
    [Migration("20230507031440_updateDB2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HueFestivalAPI.Models.HoaDon", b =>
                {
                    b.Property<int>("IdHoaDon")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HueFestivalAPI.Models.Checkin", b =>
                {
                    b.HasOne("HueFestivalAPI.Models.HoaDon", "HoaDon")
                        .WithMany("Checkins")
            ...
            modelBuilder.Entity("HueFestivalAPI.Models.HoaDon", b =>
                {
                    b.HasOne("HueFestivalAPI.Models.ChiTietDiemBanVe", "ChiTietDiemBanVe")
                        .WithMany("HoaDons")
                        .HasForeignKey("IdChiTietDiemBanVe")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HueFestivalAPI.Models.KhachHang", "KhachHang")
                        .WithMany("HoaDons")
                        .HasForeignKey("IdKhachHang")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChiTietDiemBanVe");
