...
namespace HueFestivalAPI.Migrations
{
    ...
    [Migration("20230524094613_updateDB13")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HueFestivalAPI.Models.Checkin", b =>
                {
                    b.HasOne("HueFestivalAPI.Models.KichHoatVe", "KichHoatVe")
                        .WithMany("Checkins")
                        .HasForeignKey("IdKichHoat")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("KichHoatVe");
                });
